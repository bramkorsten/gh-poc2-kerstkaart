class GameControls {
  ...
  goToGameCamera() {
    ...
    const to = new THREE.Vector3(-1.9, 1, 0.04);
    ...
    var tweenCameraTarget = new TWEEN.Tween(game.controls.target)
      ...
      .onComplete(function() {
        game.controls.minAzimuthAngle = -1.8;
        game.controls.maxAzimuthAngle = -1.2;
  ...
  goToQueueCamera() {
    const position = new THREE.Vector3(
      this.savedCameraPosition.x,
      this.savedCameraPosition.y,
      this.savedCameraPosition.z,
    );
